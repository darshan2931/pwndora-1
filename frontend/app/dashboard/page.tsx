          ...
          <Card hover>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">{data.matched_skills?.length || 0}</p>
              </div>
            </div>
          </Card>
          ...
          <Card hover>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">{data.missing_skills?.length || 0}</p>
              </div>
            </div>
          </Card>
            ...
            <Card hover>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">{data.estimated_weeks} weeks</p>
                </div>
              </div>
            </Card>
          )}
            ...
            <Card hover>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">{data.study_hours}h/week</p>
                </div>
              </div>
            </Card>
          )}
      ...
      {data.ai_summary && (
        <Card className="mb-8">
          ...
          <div className="mt-4 p-4 bg-gray-50 rounded-lg">
            <p className="text-gray-700 whitespace-pre-line leading-relaxed">{data.ai_summary}</p>
          </div>
        </Card>
      )}
          ...
          <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
            {data.recommended_projects.map((p, i) => (
              <div key={i} className="p-3 bg-gray-50 rounded-lg border border-gray-200">
                ...
                <p className="text-xs text-gray-500 mt-1">{p.difficulty} · {p.estimated_hours}h</p>
