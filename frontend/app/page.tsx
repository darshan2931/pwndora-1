...
export default function Home() {
  return (
    <div className="fade-in">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {steps.map((step) => (
            <div key={step.number} className="text-center">
              <div className="w-14 h-14 bg-primary/10 text-primary rounded-2xl flex items-center justify-center text-lg font-bold mx-auto mb-4">
                {step.number}
              </div>
      ...
      <section className="py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {features.map((feature) => (
            <Card key={feature.title} hover className="p-6 slide-up">
      ...
      <section className="py-16">
        <Card className="bg-gradient-to-r from-primary to-blue-700 text-white text-center p-12">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/upload">
              <Button size="lg" variant="accent" className="sm:w-auto">
                Get Started Now
              </Button>
            </Link>
            <Link href="/explore">
              <Button size="lg" variant="ghost" className="sm:w-auto text-white border-white hover:bg-white/10">
                Browse Careers
              </Button>
            </Link>
          </div>
